...
// Components
import Methods from '..'
import SplineSquareForm from './Form'
...
const SplineSquare = () => {
	const { t } = useTranslation('', { keyPrefix: 'components.SplineSquare' })

	return (
		<Methods method_key="square_spline" name={t('name')} methodElement={<MethodLogic t={t} />} codeElement={<span />} />
	)
}

SplineSquare.propTypes = {}

export default SplineSquare
