...
const Jacobi = () => {
	const { t } = useTranslation('', { keyPrefix: 'components.Jacobi' })

	return <Methods method_key="jacobi" name={t('name')} methodElement={<MethodLogic t={t} />} codeElement={<span />} />
}
