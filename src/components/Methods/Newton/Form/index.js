		...
		<Formik initialValues={initial_values} onSubmit={handleSubmit} validationSchema={() => validateSchema()}>
			<Form>
				<Paper sx={{ p: 2, mb: 2 }} elevation={0}>
					...
					<FunctionInput name="derivate" label={t('fields.derivate')} adornment="f'(x)" controlled hide_actions />
				</Paper>

				<Paper sx={{ p: 2, mb: 2 }} elevation={0}>
					<NumberInput name="x0" label={t('fields.x0')} adornment={{ start: 'x0' }} no_margin />
				</Paper>
