...
const SplineCubicForm = ({ onComplete, onStart }) => {
	const { t } = useTranslation('', { keyPrefix: 'components.SplineCubic.form' })
...
export default SplineCubicForm
