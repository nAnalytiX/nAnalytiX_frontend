...
const SplineLinearForm = ({ onComplete, onStart }) => {
	const { t } = useTranslation('', { keyPrefix: 'components.SplineLinear.form' })
...
export default SplineLinearForm
