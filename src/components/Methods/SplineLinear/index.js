...
// Components
import Methods from '..'
import SplineLinearForm from './Form'
...
const SplineLinear = () => {
	const { t } = useTranslation('', { keyPrefix: 'components.SplineLinear' })

	return (
		<Methods method_key="linear_spline" name={t('name')} methodElement={<MethodLogic t={t} />} codeElement={<span />} />
	)
}

SplineLinear.propTypes = {}
