/**
 * Translations for MethodsMultipleRoots
 */

const MultipleRoots_T = {
	es: {
		name: 'Método de Raíces Múltiples',
		empty_table:
		...
		errors: {
			...
			derivate: 'La Función Prima tiene errores, por favor revisala nuevamente.',
			second_derivate: 'La Función Segunda Prima tiene errores, por favor revisala nuevamente.',
			...
			derivate_zero: 'La Derivada equivale a Cero.',
		},
	},
	en: {
		name: 'Multiple Roots Method',
	},
}

export default MultipleRoots_T
