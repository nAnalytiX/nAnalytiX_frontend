/**
 *
 *  Methods/FactorizationLuPartial/Form
 *
 */
...
const FactorizationLuPartialForm = ({ onComplete, onStart }) => {
	const { t } = useTranslation('', { keyPrefix: 'components.FactorizationLuPartial.form' })
...
export default FactorizationLuPartialForm
