/**
 *
 *  Methods/FactorizationLuPartial
 *
 */
...
import FactorizationLuPartialForm from './Form'
					...
					<div key={index} className="d-flex flex-column mb-4">
						...
						<div key={index} className="d-flex mb-4">
							...
							<div className="d-flex flex-column">
								{iteration.M.map((row, indexJ) => (
									<div
										key={indexJ}
										style={{
											display: 'grid',
											gridTemplateColumns: `repeat(${iteration.M.length}, 110px)`,
											gridGap: '20px',
										}}
									>
...
const FactorizationLuPartial = () => {
	const { t } = useTranslation('', { keyPrefix: 'components.FactorizationLuPartial' })

	return <Methods method_key="pivot_lu" name={t('name')} methodElement={<MethodLogic t={t} />} codeElement={<span />} />
}

FactorizationLuPartial.propTypes = {}

export default FactorizationLuPartial
