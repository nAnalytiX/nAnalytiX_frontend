...
import FactorizationLuSimpleForm from './Form'
...
const FactorizationLuSimple = () => {
	const { t } = useTranslation('', { keyPrefix: 'components.FactorizationLuSimple' })

	return (
		<Methods method_key="simple_lu" name={t('name')} methodElement={<MethodLogic t={t} />} codeElement={<span />} />
	)
}

FactorizationLuSimple.propTypes = {}

export default FactorizationLuSimple
