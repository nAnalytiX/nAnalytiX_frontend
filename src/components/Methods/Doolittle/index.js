...
import DoolittleForm from './Form'
...
const Doolittle = () => {
	const { t } = useTranslation('', { keyPrefix: 'components.Doolittle' })

	return (
		<Methods method_key="doolittle" name={t('name')} methodElement={<MethodLogic t={t} />} codeElement={<span />} />
	)
}
