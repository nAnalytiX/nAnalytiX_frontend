...
const Sor = () => {
	const { t } = useTranslation('', { keyPrefix: 'components.Sor' })

	return <Methods method_key="sor" name={t('name')} methodElement={<MethodLogic t={t} />} codeElement={<span />} />
}
