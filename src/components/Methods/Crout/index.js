...
const Crout = () => {
	const { t } = useTranslation('', { keyPrefix: 'components.Crout' })

	return <Methods method_key="crout" name={t('name')} methodElement={<MethodLogic t={t} />} codeElement={<span />} />
}
