...
const T1 = generateTypographyStyle('4rem', '3.5rem', 700, '-0.02em') // 64px
const T2 = generateTypographyStyle('3rem', '3rem', 500, '-0.02em') // 48px
const T3 = generateTypographyStyle('2.5rem', '2.75rem', 500) // 40px
const T4 = generateTypographyStyle('2rem', '2.5rem', 500) // 32px
const C1 = generateTypographyStyle('1.75rem', '2.35rem', 500) // 24px
